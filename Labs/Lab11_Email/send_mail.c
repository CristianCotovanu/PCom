...
int main(int argc, char **argv) {
    ...
    sprintf(sendbuf, "HELO Cristian");
    send_command(sockfd, sendbuf, "250");

    // TODO 4: trimiteti comanda de MAIL FROM
    sprintf(sendbuf, "MAIL FROM: cristian.cotovanu777@gmail.com");
	send_command(sockfd, sendbuf, "250");

    // TODO 5: trimiteti comanda de RCPT TO
    sprintf(sendbuf, "RCPT TO: dorinel.filip@upb.com");
	send_command(sockfd, sendbuf, "250");
    ...
    sprintf(sendbuf, "Subject: Laborator PC" "\r\n"
                "From: Cristian Cotovanu <cristian.cotovanu77@gmail.com>" "\r\n"
                "To: Dorinel Filip <dorinel.filip@upb.com>" "\r\n"
                "Mime-Version: 1.0" "\r\n"
